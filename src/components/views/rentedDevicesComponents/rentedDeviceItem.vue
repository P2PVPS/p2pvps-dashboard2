  ...
  methods: {
    ...
    marketBtnCtl: function() {
      ...
      if (!this.device.obContract) {
        ...
        var removeObListingPromise = $
          .get("/api/ob/removeMarketListing/" + obContractId, "", data => {
            // debugger
    ...
    submitToMarket: function() {
      ...
      var createModelPromise = $
        .post("/api/obContract/create", obj, data => {
          // debugger
      ...
      createModelPromise
        ...
        .then(obContractModel => {
          var createObListingPromise = $
            .get("/api/ob/createMarketListing/" + obContractModel.collection._id, "", data => {
              // debugger
